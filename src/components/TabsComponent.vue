  ...
  <div class="tabs">
    ...
    <div class="tabs__content">
      ...
      <div v-if="active === 0" class="btn-add">
        <button class="btn-add-new" @click="addNewCity" :disabled="isDisabled">Додати нове місто</button>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      apiKey: "d4a62094f2d02f3dc31b199852c507b5",
      active: 0,
      items: [
        'Головна',
        'Обране'
  ...
  methods: {
    ...
    async getForFiveDays(item) {
      if (this.daysOfWeek.length && this.temp.length) {
        this.daysOfWeek = []
        this.temp = []
      }
